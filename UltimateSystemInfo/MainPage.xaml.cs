...
namespace UltimateSystemInfo
{
    ...
    public sealed partial class MainPage : Page
    {
        public MainPage()
        {
            ...
            var family = (string)Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\BIOS").GetValue("SystemFamily");
            var firmwareVersion = (string)Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\BIOS").GetValue("BIOSVersion");
            var firmwareReleaseDate = (string)Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\BIOS").GetValue("BIOSReleaseDate");
            var firmwareVendor = (string)Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\BIOS").GetValue("BIOSVendor");
            var boardManufacturer = (string)Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\BIOS").GetValue("BaseBoardManufacturer");
            var boardProduct = (string)Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\BIOS").GetValue("BaseBoardProduct");
            var boardVersion = (string)Registry.LocalMachine.OpenSubKey("HARDWARE\\DESCRIPTION\\System\\BIOS").GetValue("BaseBoardVersion");
            DeviceName.Text = model;
            DeviceFamilyText.Text = family;
            FirmwareType.Text = FirmwareInterface.GetFirmwareTypeAsString();
            FirmwareVendor.Text = firmwareVendor;
            FirmwareVersion.Text = firmwareVersion;
            FirmwareReleaseDate.Text = firmwareReleaseDate;
            BoardVendor.Text = boardManufacturer;
            BoardVersion.Text = boardProduct;
            BoardFirmware.Text = boardVersion;
